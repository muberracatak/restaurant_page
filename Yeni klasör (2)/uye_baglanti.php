<?php
$connection = mysqli_connect('localhost','root','Mub147852.','285591') or die ("baglantı saglanamadi");
mysqli_select_db($connection,'285591') or die ("veri tabanı baglantisi saglanamadi.");
